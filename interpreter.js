...
const literals={"\u96f6": 0, "\u4e00": 1, "\u4e8c": 2, "\u4e09": 3, "\u56db": 4, "\u4e94": 5, "\u516d": 6, "\u4e03": 7, "\u516b": 8, "\u4e5d": 9, "\u5341": 10, "\u767e": 100, "\u5343": 1000, "\u4e07": 10000, "\u4ebf": 100000000, "\u5146": 1000000000000};
function ttop(stack){
...
function interpret_step(code,rows,cols){
    ...
    switch(code[curip.x][curip.y]){
        ...
        case '\u53cc':{
            ...
            var ip={x:a,y:b,dx:dir[c&3][0],dy:dir[c&3][1],stack:[],stack1:[]};
            queue.push(ip);
            break;
        }
        case '\u505c':{
        ...
        case '\u542c':{
            if(this.input_pointer>=this.input.length){
                ...
                while(this.input_pointer<this.input.length&&' \n\r\v\t'.includes(this.input[this.input_pointer])){
                    ++this.input_pointer;
                }
                curip.stack.push(+k);
            }
        ...
        default:{
            if('\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u767e\u5343\u4e07\u4ebf\u5146'.includes(code[curip.x][curip.y])){
...
function display_queue(){
    ...
    for(let i of queue){
        if(lang){
            res+='<br/><hr/>\u6a2a\u5750\u6807: '+i.x+'    \u7eb5\u5750\u6807: '+i.y+'    \u68081: '+i.stack+'    \u68082: '+i.stack1;
        }else{
            res+='<br/><hr/>x: '+i.x+'    y: '+i.y+'    First Stack: '+i.stack+'    Second Stack: '+i.stack1;
        }
    }
